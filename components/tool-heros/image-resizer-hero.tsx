...
import { ImageIcon, Maximize, Move, CheckCircle } from 'lucide-react';

export function ImageResizerHero() {
  return (
      ...
      <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8">
        <div className="text-center">
          <div className="mb-6 inline-flex items-center gap-2 px-4 py-2 rounded-full bg-accent/10 text-accent border border-accent/20 text-sm font-medium">
            ...
            <span>Browser-Based Resizing</span>
          </div>
          ...
          <p className="text-lg sm:text-xl text-foreground/70 mb-8 max-w-2xl mx-auto text-balance leading-relaxed font-medium">
            Perfectly resize your images for social media, web, or print. Maintain aspect ratio or set custom dimensions with pixel-perfect precision—all locally in your browser.
          </p>
